...
let menuBody = document.querySelector('.catalog__body');
let catTitle = document.querySelector('.catTitle');
let catList = document.querySelector('.menu--list');
let phone = document.querySelector('.header__contacts--phone');
let mail = document.querySelector('.header__contacts--mail');
if (document.documentElement.clientWidth <= 1152) {
	menuBody.prepend(catTitle);
...
if (document.documentElement.clientWidth <= 630) {
	menuBody.append(phone);
	menuBody.append(mail);
}
